...
public enum MemberErrorCode implements BaseErrorCode {
	...
	INVALID_EMAIL(BAD_REQUEST, "MEMBER_400_6", "이메일 형식이 요구 조건에 맞지 않습니다."),
	...
	INVALID_VERIFICATION_CODE(BAD_REQUEST, "MEMBER_400_7", "인증코드가 일치하지 않습니다."),

	@ExplainError("인증 코드가 만료된 경우 발생하는 오류입니다.")
	EXPIRATION_VERIFICATION_CODE(BAD_REQUEST, "MEMBER_400_8", "인증코드가 만료 되었습니다."),

	@ExplainError("단과대와 학과가 일치하지 않는 경우 발생하는 오류입니다.")
	INVALID_COLLEGE_AND_MAJOR(BAD_REQUEST, "MEMBER_400_9", "단과대와 학과가 일치하지 않습니다."),

	@ExplainError("단과대 값이 유효하지 않은 enum인 경우 발생하는 오류입니다.")
	INVALID_COLLEGE_ENUM(BAD_REQUEST, "MEMBER_400_10", "잘못된 단과대 값입니다."),

	@ExplainError("학과 값이 유효하지 않은 enum인 경우 발생하는 오류입니다.")
	INVALID_MAJOR_ENUM(BAD_REQUEST, "MEMBER_400_11", "잘못된 학과 값입니다."),
