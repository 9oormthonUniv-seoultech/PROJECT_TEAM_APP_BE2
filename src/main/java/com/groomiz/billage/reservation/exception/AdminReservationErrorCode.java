...
public enum AdminReservationErrorCode implements BaseErrorCode {
	...
	INVALID_STATUS_FORMAT(BAD_REQUEST, "RESERVATION_400_1", "예약 상태 값이 올바르지 않습니다. 허용되는 값은 'pending', 'approve', 'reject'입니다."),

	@ExplainError("예약 타입 파라미터가 누락되었을 때 발생하는 오류입니다.")
	MISSING_STATUS_PARAMETER(BAD_REQUEST, "RESERVATION_400_2", "예약 상태 파라미터가 필요합니다."),

	@ExplainError("예약 유형 값이 올바르지 않을 때 발생하는 오류입니다.")
	INVALID_TYPE(BAD_REQUEST, "RESERVATION_400_8", "예약 유형 값이 올바르지 않습니다. 허용되는 값은 'single', 'period', 'recurring'입니다.");
